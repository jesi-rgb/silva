...
<SheetObject key="Box" let:Sync let:Transform let:select let:deselect>
    <Transform>
        <T.Mesh
            castShadow
            on:click={select}
        ...
        >
            <Duck />
            <T.MeshStandardMaterial let:ref transparent>
                <Sync type={ref} color roughness metalness side opacity />
            </T.MeshStandardMaterial>
        </T.Mesh>
    </Transform>
</SheetObject>

<T.Mesh receiveShadow position.y={-1} rotation.x={-90 * DEG2RAD}>
